...
class MinerInventory extends HopperInventory{
    ...
    public function getLevelItem(): Item{
        ...
        $item->setCustomName(TextFormat::LIGHT_PURPLE . "§rLevel: " . TextFormat::YELLOW .($lvl = $this->entity->getLevelM()));
        $item->setLore([TextFormat::LIGHT_PURPLE . "§rCost: " . TextFormat::YELLOW . "$" . $this->entity->getCost($lvl)]);
        return $item;
    }
