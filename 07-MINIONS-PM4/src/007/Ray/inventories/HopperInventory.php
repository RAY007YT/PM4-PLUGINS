...
class HopperInventory extends CustomInventory{
    ...
    public function getDestoryItem(): Item{
        $item = Item::get(Item::BEDROCK);
        $item->setCustomName("§r§l§ePICKUP MINION\n\n§r§bClick To Pickup Your Minion And\n§r§bGet In Your Inventory.\n\n§r§l§dClick To Pickup");
        return $item;
    }
    ...
    public function getChestItem(): Item{
        ...
        $item->setCustomName("§r§l§eLINK A CHEST\n\n§r§bClick To On And After Click In\n§r§bChest For Link Chest.\n\n§r§l§dClick To Link");
        $item->setLore([" ",  TextFormat::GOLD . "§rLinked: " . TextFormat::WHITE . $islinked, TextFormat::GREEN . "§rCoordinates: " . TextFormat::WHITE . $this->entity->getChestCoordinates()]);
        return $item;
    }
