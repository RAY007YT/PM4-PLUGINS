...
class MinionEntity extends Human{
    ...
    public function sendSpawnItems(): void{
        ...
        $armor1->setNamedTagEntry(new ListTag("ench"));
        $color = new Color(255, 0, 0);
        $armor2 = Item::get(299, 0, 1);
        $armor2->setNamedTagEntry(new ListTag("ench"));
        $armor2->setCustomColor($color);
        $armor3 = Item::get(300, 0, 1);
        $armor3->setNamedTagEntry(new ListTag("ench"));
        $armor3->setCustomColor($color);
        $armor4 = Item::get(301, 0, 1);
        $armor4->setNamedTagEntry(new ListTag("ench"));
